                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="email" name="Email" class="form-control" placeholder="Enter Email" value="{{ $company->Email }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="Website" class="form-control" placeholder="Enter Website" value="{{ $company->Website }}">
                                    </div>
                                </div>
